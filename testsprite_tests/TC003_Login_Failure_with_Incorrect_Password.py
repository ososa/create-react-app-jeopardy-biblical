...
async def run_test():
    ...
    try:
        ...
        # -> Input registered email into Email field (index 569), input incorrect password into Password field (index 543), then click the LOG IN button (index 547).
        ...
        try:
            ...
            raise AssertionError("Test case failed: Expected an error message indicating the login was rejected for an incorrect password (e.g., 'Invalid email or password') after submitting wrong credentials, but no such message was displayed")
